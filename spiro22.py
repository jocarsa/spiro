...
def reset_drawing_conditions():
    global trace_canvas, arms_canvas  # Make sure these variables are accessible and modifiable inside the function
...
try:
    while frame_count < max_frames:
        ...
        if drawing_started:
            cv2.line(trace_canvas, (previous_x, previous_y), (x_current, y_current), trace_color, random.randint(5,125), cv2.LINE_AA)  # Anti-aliased line
