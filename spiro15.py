...
for i in range(0, 25):
    ...
    try:
        while frame_count < max_frames:
            ...
            if drawing_started:
                cv2.line(trace_canvas, (previous_x, previous_y), (x_current, y_current), trace_color, 25, cv2.LINE_AA)  # Anti-aliased line
            ...
            # Combine the trace canvas and arms canvas
            final_frame = cv2.addWeighted(trace_canvas, 0.5, arms_canvas, 0.5, 0)
